function Icon({ d, viewBox = "0 0 24 24", width = 16, height = 16, className, style, ...props }) {
  return (
    <svg
...
export function HomeIcon(props) {
  return <Icon d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" {...props} />;
}
...
export function CheckIcon(props) {
  return <Icon d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" {...props} />;
}
